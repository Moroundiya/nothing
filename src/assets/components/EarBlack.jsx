...
function EarBlack() {
    return (
        <div className='w-full h-auto bg-black text-center py-12 lg:pt-[6rem]'>
            ...
            <p className='text-md sm:text-[1.13rem] leading-snug px-3 md:w-3/5 lg:text-xl text-[#DCDCDC] font-[Figtree] font-thin my-5 lg:w-2/4 mx-auto' data-aos='zoom-in'>Tech you can’t feel. Leaving just space for sound to come to life. Powered by custom sound technology. Beautifully authentic, at any frequency.</p>
