...
function Enhance() {
    ...
    return (
        <div className={`h-[650px] lg:h-[1000px] w-full pb-10 pr-4 md:pr-8 lg:pr-16 relative bg-cover bg-enhance bg-center bg-no-repeat flex items-end justify-end flex-col lg:pb-[8rem] tab-parent`}>
