    ...
    return (
        <div className='w-full h-auto py-1 pb-12 md:h-[500px] md:py-14 lg:h-[1000px] bg-airpod-bg bg-bottom bg-cover bg-no-repeat text-center lg:py-16 overflow-hidden'>
            <div data-aos="flip-up" className='overflow-hidden'>
                <h1 className='text-4xl lg:text-6xl font-[Ndot] text-white'>EAR (2) BLACK</h1>
                <p className='text-lg text-white pt-3 pb-2 font-[Figtree] font-thin lg:pt-5 lg:pb-3'>Shaped for enhanced comfort.</p>
                <a href="#" className='font-[Figtree] text-white text-lg font-thin'>Pre order</a>
            </div>
